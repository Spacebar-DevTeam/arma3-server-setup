...
/* Mission System Settings */
	...
	DMS_MaxBanditMissions				= 2;						// 5 Maximum number of Bandit Missions running at the same time
	...
	DMS_MissionTimeout					= 2400; 					// [900,1800] [Minimum,Maximum] time it will take for a mission to timeout | DEFAULT: 15-30 mins
	DMS_MissionTimeoutResetRange		= 600;						// 1500 If a player is this close to a mission then it won't time-out. Set to 0 to disable this check.
	...
	DMS_MarkerText_AIName				= "Dildos";					// What the AI will be called in the map marker. For example, the marker text can show: "Car Dealer (3 Units remaining)"
	...
	*/
	...
	DMS_BanditMissionTypes 				= [								 //	List of missions with spawn chances. If they add up to 100%, they represent the percentage chance each one will spawn
											["bandits",4],               // Slightly more common
											["bauhaus",2],               // Less common
											["beertransport",3],
											["behindenemylines",4],      // Increased for more military-style missions
											["blackhawkdown",4],         // A challenging and engaging mission
											["cardealer",3],
											["construction",2],          // Lower priority
											["donthasslethehoff",3],
											["foodtransport",3],
											["guntransport",3],
											["humanitarian",2],          // Possibly less exciting for players
											["lost_battalion",4],        // Increase challenging missions
											["medical",2],               // Lower priority
											["mercbase",2],
											["mercenaries",3],
											["nedbuilding1_mission",3],
											["nedcar_mission",4],        // Retained as a staple mission
											["nedguns1_mission",3],
											["nedhatchback_mission",3],
											["nedhunter_mission",2],
											["nedifrit_mission",2],
											...
											["nedoffroad_mission",3],
											["nedresearch_mission",3],
											["nedsnipercamp_mission",4], // Increase for sniper and stealth missions
											["nedstrider_mission",2],
											["nedural_mission",3],
											["roguenavyseals",4],        // Emphasize special forces missions
											["thieves",3],
											["walmart",2]                // Lower priority
										];
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_share_info_distance			= 15;						// The distance killer's info will be shared to other AI
	...
	DMS_AI_destroyVehicleChance			= 49;						// Percent chance that an AI vehicle will be destroyed after the AI have been killed. Set to 100 for always, or 0 for never.
...
/* Loot Settings */
	DMS_GodmodeCrates 					= false;					// Whether or not crates will have godmode after being filled with loot.
	...
	DMS_CarThievesVehicles =			[	// List of vehicles that can spawn in the "car thieves" mission. By default, it's just "DMS_MilitaryVehicles" and "DMS_TransportTrucks".
											//"Exile_Car_Offroad_Armed_Guerilla01"
										] + DMS_MilitaryVehicles + DMS_TransportTrucks + DMS_RefuelTrucks + DMS_TransportTrucks + DMS_ArmedVehicles;
/* Loot Settings */
