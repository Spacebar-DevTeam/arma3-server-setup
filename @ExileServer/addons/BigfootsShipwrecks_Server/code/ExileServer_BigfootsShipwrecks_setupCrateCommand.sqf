...
{
    diag_log format ["BigfootsShipwrecks :: Spawning Sniper loot in crate %1", _crate];
    ...
    exitWith
    {
        diag_log format ["BigfootsShipwrecks ERROR :: Invalid _crateValues for Sniper: %1", _crateValues];
    };
    ...
    diag_log format ["BigfootsShipwrecks :: Sniper crate %1 filled with loot.", _crate];
}
else
{
    diag_log format ["BigfootsShipwrecks :: Filling crate %1 with standard loot.", _crate];
