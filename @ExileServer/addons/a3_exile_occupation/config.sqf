...
SC_occupyTraderDetails      	= [
									...
									["Chernarusredux", "Redux Traders", [7317,7217,0], "trader1.sqf", true, 250]
								  ];
...
SC_occupyTransportStartPos  	= [
									[10752.1,2199.96,0]					// Electro - if empty defaults to map centre
								];                   				
...
SC_TransportAirWaypoints    	= [
                                    [7341.77,3009.77,0],				// cherno
                                    [1603.06,2404.68,0],				// kamenka
                                    [1690.29,5086.01,0],				// zelenogorsk
                                    [2261.28,7738.21,0],				// pustoska
									[1902.54,12445.2,0],				// skalka
									[8151.39,14021.2,0],				// batarov swamp
									[14835.2,13659.1,0],				// guba reef
									[13083.6,10097.9,0],				// berezino
									[13532.7,6275.29,0]					// solnichi
                                ];
...
SC_BanditFirstNames 			= ["Adolf","Joseph","Benito","Saddam","Muammar","Idi","Pol","Mao","Vladimir","Augusto","Kim","Francisco","Nicolás","Bashar","Enver"];
SC_BanditLastNames 				= ["Hitler","Stalin","Mussolini","Hussein","Gaddafi","Amin","Pot","Zedong","Putin","Pinochet","Jong-un","Franco","Maduro","Assad","Hoxha"];
*/
SC_SurvivorFirstNames = [
    "Homer", "Fred", "Scooby", "Shaggy", "Mickey", 
    "Goofy", "Donald", "Bugs", "Daffy", "Popeye", 
    "SpongeBob", "Patrick", "Bart", "Stewie", "Eric"
];

SC_SurvivorLastNames = [
    "Simpson", "Flintstone", "Doo", "Rogers", "Mouse", 
    "Pluto", "Duck", "Bunny", "Duck", "Sailor", 
    "SquarePants", "Star", "Griffin", "Griffin", "Cartman"
];

SC_BanditFirstNames = [
    "Elmer", "Yosemite", "Wile", "Stewie", "Mr.", 
    "Gargamel", "Skeletor", "Zim", "Plankton", "Megatron", 
    "Darth", "Bender", "Vlad", "Mojo", "Cobra"
];

SC_BanditLastNames = [
    "Fudd", "Sam", "Coyote", "Griffin", "Burns", 
    "Smurf", "Evil", "Invader", "Krabs", "Prime", 
    "Vader", "Rodriguez", "The Impaler", "Jojo", "Commander"
];
