...
hint "ZCP startZCP executed";
diag_log "ZCP startZCP executed";

hint format ["ZCP initialized for %1 with center %2 and radius %3", worldName, ZCP_MapCenterPos, ZCP_MapRadius];
diag_log format ["ZCP initialized for %1 with center %2 and radius %3", worldName, ZCP_MapCenterPos, ZCP_MapRadius];
...
{
	case "chernarusredux": 								// Center and radius settings for Chernarus Redux
	{
		ZCP_MapCenterPos = [7100,7100]; 				// Approximate center of Chernarus Redux
		ZCP_MapRadius = 10000; 							// Adjust radius as needed
	};
