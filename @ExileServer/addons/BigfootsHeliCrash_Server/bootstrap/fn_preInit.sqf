 ...
 *
 * The new version ensures AI guards, reinforcements, and water missions function correctly.
 *  - The old version is missing key features that are part of the new system.
*/
